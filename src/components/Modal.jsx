    ...
    return(
        <div className='absolute bg-black opacity-90 top-0 left-0 right-0 bottom-0'>
            ...
            <form className='flex flex-col text-white w-1/2 h-screen m-auto justify-center gap-6' onSubmit={handleSubmit}>
                ...
                <input type="text" name="nameExpense" id="nameExpense" placeholder='Expense name' className='p-1 rounded-md pl-3 text-black'/>
                </section>

                <section className='flex flex-col gap-1'>
                <label htmlFor="amountExpense">Amount</label>
                <input type="number" name="amountExpense" id="amountExpense" placeholder='E.g. $120' className='p-1 rounded-md pl-3 text-black' />
                </section>

                <section className='flex flex-col gap-1'>
                <label htmlFor="categoryExpense">Category</label>
                <select name="categoryExpense" id="categoryExpense" className='p-1 rounded-md pl-3 text-black'>
                ...
                <input type="submit" value="Submit" className='bg-blue-500 p-2 mt-2 hover:bg-blue-600 rounded-lg text-white font-medium text-lg uppercase'/>
                {error && <Error type="error" customStyles="w-full text-center mt-0">All fields must be filled</Error>}
            </form>
        </div>
    )
}
