...
function NewExpense() {
  ...
  return (
    <div className="bg-white h-72 rounded-lg mt-10 w-4/5 lg:w-3/5 mx-auto flex flex-col justify-center  shadow-lg">
      ...
      >
        ...
        <input
          type="number"
          className="bg-gray-200 w-4/5 lg:w-1/2 p-2 rounded-lg text-center font-medium text-md placeholder:text-gray-500"
          name="budgetValue"
          id="budgetValue"
        ...
        <button
          type="submit"
          className="bg-blue-500 w-4/5 lg:w-1/2 rounded-lg p-2 text-white font-medium text-lg uppercase"
        >
          Set budget
        </button>
      </form>
